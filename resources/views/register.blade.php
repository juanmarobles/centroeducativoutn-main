...
<html lang="en">
    ...
    <head>
        ...
        <title>Centro Educativo - Register</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <hr>
                                <form method="POST" action="{{ route('crear.usuario') }}" class="user">
                                    @csrf
                                    ...
                                    <hr>
                                    <div class="form-group">
                                        <select name="rol" class="form-control form-control-user">
                                            <option value="alumno">Alumno</option>
                                            <option value="docente">Docente</option>
                                            <option value="docente">Padre</option>
                                        </select>
                                    </div>                                  
                                    <hr>
