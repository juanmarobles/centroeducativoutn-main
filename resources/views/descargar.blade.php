...
@endif
        ...
        <section class="page-section" id="inscripcion">
            <div class="contenedor-contenido">
                ...
                <h1 class="page-section-heading text-center text-uppercase text-secondary mb-0">Descargar</h1>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-ballpen" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="divider-custom"></div>
                    <a href="https://drive.google.com/file/d/1e0OH7MjjT1z58WWxZWdBID7Kj7a80WH7/view?usp=drive_link" class="btn btn-primary" download>
                        Descargar la aplicación
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-ballpen" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <!-- Tu ícono aquí -->
                        </svg>
                    </a>
