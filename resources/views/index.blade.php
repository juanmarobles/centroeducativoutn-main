...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <% HttpSession misession = request.getSession();
            ...
            if (usuario == null) {
                response.sendRedirect("indexinvitado.jsp");
            }
        %>
        -->
        <!-- Navigation-->
        <nav class="navbar nav-bg navbar-expand-lg text-uppercase fixed-top" id="mainNav">
            ...
            <div class="collapse navbar-collapse navigation navbar-nav ms-auto" id="navbarResponsive">                
                ...
                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="comentarios.jsp">Comentarios</a>
                ...
                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="empleo.jsp">Empleo</a>
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img class="img-profile rounded-circle" src="img/undraw_profile.svg" width="40" height="40"> <!-- Ajusta el ancho y alto aquí -->
                    </a>
                    <!-- Dropdown - User Information -->
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="#" onclick="confirmLogout()" style="background: none;">
                ...
                <div class="contenedor-contenido">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xl-7">
                            ...
                            <!-- to get an API token!-->
                            <form action="SvFormInscripcion" method="POST" id="contactForm">
                                <!-- Name input-->
